...
P.downsi.CI <- group.CI(P.downsi ~ Trap, Q1.Q3.T3T4.weather, ci = 0.95)

P.downsi.fig <-  ggplot(P.downsi.CI, aes(x=Trap, y=P.downsi.mean)) +
	geom_errorbar( aes(x=Trap, ymin=P.downsi.lower, ymax=P.downsi.upper), width=0.1) +
...
P.downsi.fig + theme(text=element_text(size=16), axis.title=element_text(face="bold.italic",
	size="18", color="black"), legend.position="top")
...
Moths.CI <- group.CI(Moths ~ Trap, Q1.Q3.T3T4.weather, ci = 0.95)

Moths.fig <-  ggplot(Moths.CI, aes(x=Trap, y=Moths.mean)) +
  geom_errorbar( aes(x=Trap, ymin=Moths.lower, ymax=Moths.upper), width=0.1) +
...
Moths.fig + theme(text=element_text(size=16), axis.title=element_text(face="bold.italic",
                                                                         size="18", color="black"), legend.position="top")
...
Diptera.CI <- group.CI(Diptera ~ Trap, Q1.Q3.T3T4.weather, ci = 0.95)


Diptera.fig <-  ggplot(Diptera.CI, aes(x=Trap, y=Diptera.mean)) +
  geom_errorbar( aes(x=Trap, ymin=Diptera.lower, ymax=Diptera.upper), width=0.1) +
  geom_point() + xlab("Trap height") + ylab("# Diptera") + scale_x_discrete(labels = c('3.1-5.5m', '5.1-7.5m', '7.1-9.5m', '9.1-11.5m', '11.1-13m'))
Diptera.fig <- Diptera.fig + theme_classic()
Diptera.fig + theme(text=element_text(size=16), axis.title=element_text(face="bold.italic",
                                                                      size="18", color="black"), legend.position="top")
...
P..versicolor.CI <- group.CI(P..versicolor ~ Trap, Q1.Q3.T3T4.weather, ci = 0.95)


P..versicolor.fig <-  ggplot(P..versicolor.CI, aes(x=Trap, y=P..versicolor.mean)) +
  geom_errorbar( aes(x=Trap, ymin=P..versicolor.lower, ymax=P..versicolor.upper), width=0.1) +
  geom_point() + xlab("Trap height") + ylab("# Po .versicolor") + scale_x_discrete(labels = c('3.1-5.5m', '5.1-7.5m', '7.1-9.5m', '9.1-11.5m', '11.1-13m'))
P..versicolor.fig <- P..versicolor.fig + theme_classic()

P..versicolor.fig + theme(text=element_text(size=16), axis.title=element_text(face="bold.italic",
                                                                        size="18", color="black"), legend.position="top")
...
P.downsi.SR <- ggplot(SR, aes(x=Trap, y=binomial_CI$mean)) +
...
P.downsi.SR + theme(text=element_text(size=16), axis.title=element_text(face="bold.italic",
size="18", color="black"), legend.position="top") + labs(colour = "Sex ratio") + xlab("Trap height")      
